...
class AtlasDownloadManager < Formula
  ...
  url "https://github.com/xkam7ar/atlas-download-manager/releases/download/v0.1.0/atlas_download_manager-0.1.0.tar.gz"
  sha256 "1d5b39752ac8ff685f3ab11d8f38bbe639a7019ecb92df5bf19d43e79ac2162b"
  license "MIT"
  ...
  test do
    ...
    output = shell_output(
      "#{bin}/atlas get https://example.com/archive.zip --kind file --backend native " \
      "--output-dir #{testpath} --dry-run --json",
    )
    assert_match '"engine": "native"', output
    assert_match '"dry run: no network request or download"', output
  end
end
